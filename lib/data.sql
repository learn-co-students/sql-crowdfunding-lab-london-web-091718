...
-- note: first primary key in each entry (e.g 1 in Finnebar entry) is not necessary
-- as this is given automatically due to setting primary key in 'create table'
